...
"""autogenerated by genpy from multi_robot/gotoAction.msg. Do not edit."""
import codecs
import sys
...
class gotoAction(genpy.Message):
  _md5sum = "5a38377951750712ae7d2c90e35c9b2d"
  _type = "multi_robot/gotoAction"
...
"""
  ...
  _slot_types = ['multi_robot/gotoActionGoal','multi_robot/gotoActionResult','multi_robot/gotoActionFeedback']
  ...
  def __init__(self, *args, **kwds):
    ...
    if args or kwds:
      ...
      if self.action_goal is None:
        self.action_goal = multi_robot.msg.gotoActionGoal()
      if self.action_result is None:
        self.action_result = multi_robot.msg.gotoActionResult()
      if self.action_feedback is None:
        self.action_feedback = multi_robot.msg.gotoActionFeedback()
    else:
      self.action_goal = multi_robot.msg.gotoActionGoal()
      self.action_result = multi_robot.msg.gotoActionResult()
      self.action_feedback = multi_robot.msg.gotoActionFeedback()
  ...
  def serialize(self, buff):
    ...
    try:
      ...
      if python3 or type(_x) == unicode:
        ...
        length = len(_x)
      buff.write(struct.Struct('<I%ss'%length).pack(length, _x))
      length = len(self.action_goal.goal.order)
      buff.write(_struct_I.pack(length))
      pattern = '<%si'%length
      buff.write(struct.Struct(pattern).pack(*self.action_goal.goal.order))
      _x = self
      ...
      buff.write(_struct_I.pack(length))
      pattern = '<%si'%length
      buff.write(struct.Struct(pattern).pack(*self.action_result.result.sequence))
      _x = self
      ...
      buff.write(_struct_I.pack(length))
      pattern = '<%si'%length
      buff.write(struct.Struct(pattern).pack(*self.action_feedback.feedback.sequence))
  ...
  def deserialize(self, str):
    ...
    try:
      ...
      self.action_goal.goal.order = s.unpack(str[start:end])
      _x = self
      start = end
      end += 12
      ...
      self.action_result.result.sequence = s.unpack(str[start:end])
      _x = self
      start = end
      end += 12
      ...
      self.action_feedback.feedback.sequence = s.unpack(str[start:end])
      return self
  ...
  def serialize_numpy(self, buff, numpy):
    ...
    try:
      ...
      buff.write(_struct_I.pack(length))
      pattern = '<%si'%length
      buff.write(self.action_goal.goal.order.tostring())
      _x = self
      buff.write(_get_struct_3I().pack(_x.action_result.header.seq, _x.action_result.header.stamp.secs, _x.action_result.header.stamp.nsecs))
      _x = self.action_result.header.frame_id
      length = len(_x)
  ...
  def deserialize_numpy(self, str, numpy):
    ...
    try:
      ...
      self.action_goal.goal.order = numpy.frombuffer(str[start:end], dtype=numpy.int32, count=length)
      _x = self
      start = end
      end += 12
      (_x.action_result.header.seq, _x.action_result.header.stamp.secs, _x.action_result.header.stamp.nsecs,) = _get_struct_3I().unpack(str[start:end])
