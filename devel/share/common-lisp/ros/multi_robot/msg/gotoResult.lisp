...
(cl:defmethod cl:initialize-instance :after ((m <gotoResult>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'gotoResult)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name multi_robot-msg:<gotoResult> is deprecated: use multi_robot-msg:gotoResult instead.")))

(cl:ensure-generic-function 'sequence-val :lambda-list '(m))
(cl:defmethod sequence-val ((m <gotoResult>))
