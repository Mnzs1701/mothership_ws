...
class gotoActionFeedback {
  constructor(initObj={}) {
    if (initObj === null) {
      ...
      if (initObj.hasOwnProperty('feedback')) {
        ...
        this.feedback = new gotoFeedback();
      }
    }
  }
  ...
  static serialize(obj, buffer, bufferOffset) {
    ...
    bufferOffset = gotoFeedback.serialize(obj.feedback, buffer, bufferOffset);
    return bufferOffset;
  }
  ...
  static deserialize(buffer, bufferOffset=[0]) {
    ...
    let len;
    let data = new gotoActionFeedback(null);
    ...
    data.feedback = gotoFeedback.deserialize(buffer, bufferOffset);
    return data;
  }
  ...
  static getMessageSize(object) {
    ...
    length += gotoFeedback.getMessageSize(object.feedback);
    return length;
  }
  ...
  static Resolve(msg) {
    ...
    const resolved = new gotoActionFeedback(null);
    ...
    if (msg.feedback !== undefined) {
      resolved.feedback = gotoFeedback.Resolve(msg.feedback)
    }
    else {
      resolved.feedback = new gotoFeedback()
    }
...
module.exports = gotoActionFeedback;
